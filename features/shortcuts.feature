Feature: Shortcuts
  ...
  @testcase_263206
  Scenario: Alt-F to open File menu
    * Press "<Alt>F"
    Then "File" menu is opened

  @testcase_263195
  Scenario: Alt-E to open Edit menu
    * Press "<Alt>E"
    Then "Edit" menu is opened

  @testcase_263200
  Scenario: Alt-V to open View menu
    * Press "<Alt>V"
    Then "View" menu is opened

  @testcase_263196
  Scenario: Alt-H to open Help menu
    * Press "<Alt>H"
    Then "Help" menu is opened

  @testcase_263199
  Scenario: Alt-S to open Search menu
    * Press "<Alt>S"
    Then "Search" menu is opened

  @testcase_263198
  Scenario: Mail: Alt-O to open Folder menu
    * Open "Mail" section
    * Press "<Alt>O"
    Then "Folder" menu is opened
